...
// 文件查找类型
type NET_DVR_FILE_FIND_RES uint

const (
	NET_DVR_FILE_SUCCESS_res   NET_DVR_FILE_FIND_RES = 1000 //获取文件信息成功
	NET_DVR_FILE_NOFIND_res    NET_DVR_FILE_FIND_RES = 1001 //未查找到文件
	NET_DVR_ISFINDING_res      NET_DVR_FILE_FIND_RES = 1002 //正在查找请等待
	NET_DVR_NOMOREFILE_res     NET_DVR_FILE_FIND_RES = 1003 //没有更多的文件，查找结束
	NET_DVR_FILE_EXCEPTION_res NET_DVR_FILE_FIND_RES = 1004 //查找文件时异常
	NET_DVR_FIND_TIMEOUT_res   NET_DVR_FILE_FIND_RES = 1005 //查找文件超时
)
